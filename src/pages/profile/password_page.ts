...
import {changeLoginTypeGuard} from '../../utils/typeguards';
...
export const profileChangePasswordProps = {
    ...
    events: {
        submit(event: Event) {
            ...
            const changePasswordForm = (event.target as Element).closest(
                '.profile-page__form'
            ...
            if (
                isFormValid(changePasswordForm) &&
                changeLoginTypeGuard(formData) &&
